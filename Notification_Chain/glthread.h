...
/* glthread_node (glued double linked list) */
...
/**
 * @brief this macro if used will define function with fn_name
 *        this function will return the pointer to application data that glued in glthread
 * 
 * @param fn_name - function name that will be defined as
 * @param sturcture_name - the struct name is the application data type 
 * @param field_name - the field name that the glthread defined in the application data struct
 * 
 */
